...
namespace Logging.SmartStandards {
  ...
  internal class MyAssert {
    ...
    public static void BothSinksContain(
      ...
      TraceBusSinkContains(index, audience, level, sourceContext, sourceLineId, eventId, messageTemplate, ex);
      CustomBusSinkContains(index, audience, level, sourceContext, sourceLineId, eventId, messageTemplate, ex);
    }
