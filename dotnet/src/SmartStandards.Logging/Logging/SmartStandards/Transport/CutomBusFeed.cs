...
namespace Logging.SmartStandards.Transport {
  ...
  public class CustomBusFeed {
    ...
    public delegate void EmitMessageDelegate(string audience, int level, string sourceContext, long sourceLineId, int eventKindId, string messageTemplate, object[] args);

    public delegate void EmitExceptionDelegate(string audience, int level, string sourceContext, long sourceLineId, int eventKindId, Exception ex);
