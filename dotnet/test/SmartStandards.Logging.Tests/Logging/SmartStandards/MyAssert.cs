...
namespace Logging.SmartStandards {
  ...
  internal class MyAssert {
    ...
    public static void CustomBusSinkContains(
      int index, string audience, int level, string sourceContext, long sourceLineId, int useCaseId, string messageTemplate,
      Exception ex = null
    ) {
      ...
      Assert.AreEqual(useCaseId, AssemblyInitializer.CustomBusSink.CollectedUseCaseIds[index]);
    ...
    public static void TraceBusSinkContains(
      ...
      Assert.AreEqual(useCaseId, AssemblyInitializer.TraceBusSink.CollectedUseCaseIds[index]);
    ...
    public static void BothSinksContain(
      ...
      TraceBusSinkContains(index, audience, level, sourceContext, sourceLineId, useCaseId, messageTemplate, ex);
      CustomBusSinkContains(index, audience, level, sourceContext, sourceLineId, useCaseId, messageTemplate, ex);
    }
